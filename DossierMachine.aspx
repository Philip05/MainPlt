        ...
        <div class="container-fluid" id="containerDossierMachine">
            ...
            <div id="divDossierMachine">
                ...
                <div id="divRightDossierMachine" class="col-lg-4 col-md-5 col-sm-12 col-xs-12 ">
                    <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
                        <div class="divElement col-lg-12 col-md-12 col-sm-12 col-xs-12">
                            <ul style="color:red">
                                <li>
                                    <asp:LinkButton runat="server" ID="labelEntretiensMachine" OnClick="labelEntretiensMachine_Click" Text="Entretiens"></asp:LinkButton></li>
                            </ul>
                        </div>
                        <div class="divElement col-lg-12 col-md-12 col-sm-12 col-xs-12">
                            <ul style="color:red">
                                <li>
                                    <asp:LinkButton runat="server" ID="labelEntretiensRecents" OnClick="labelEntretiensRecents_Click" Text="Entretiens récents"></asp:LinkButton></li>
                            </ul>
                        </div>
                        <div class="divElement col-lg-12 col-md-12 col-sm-12 col-xs-12">
                            <ul style="color:red">
                                <li>
                                    <asp:LinkButton runat="server" ID="labelRemarquesMachine" OnClick="labelRemarquesMachine_Click" Text="Remarques de la machine"></asp:LinkButton></li>
                            </ul>
                        </div>
                        <div class="divElement col-lg-12 col-md-12 col-sm-12 col-xs-12">
                            <ul style="color:red">
                                <li>
                                    <asp:LinkButton runat="server" OnClick="labelProceduresMachine_Click" ID="labelProceduresMachine" Text="Procédures"></asp:LinkButton></li>
                            </ul>
                        </div>
                    </div>
                </div>
                <div id="divRight2DossierMachine" class="col-lg-3 col-md-3 col-sm-12 col-xs-12">
                    <div>
                        <asp:TextBox ID="textBoxDescriptionMachine" AutoPostBack="true" OnTextChanged="textBoxDescriptionMachine_TextChanged" TextMode="MultiLine" CssClass="col-lg-12 col-md-12 col-sm-12 col-xs-12 col-lg-offset-1 col-md-offset-1 col-sm-offset-1 col-xs-offset-1" runat="server" Height="250px"></asp:TextBox>
                    </div>
                </div>
            </div>
        </div>
